...
const CSV_URL = 'https://www2.census.gov/programs-surveys/popest/datasets/2020-2024/cities/totals/sub-est2024_48.csv';
const CSV_PATH = 'C:/tmp/sub-est2024_48.csv';
const POP_YEAR = 2024;

// Exact DB names for 12 TX cities (must match municipalities.name)
const EXPECTED_CITIES = [
  'Allen', 'Celina', 'Frisco', 'Garland', 'McKinney', 'Murphy',
  'Plano', 'Princeton', 'Prosper', 'Richardson', 'Sachse', 'Wylie'
];

// Known-good 2024 Census values for sanity check (from sub-est2024_48.csv verified 2026-05-21)
const KNOWN_VALUES = {
  Allen: 113746, Celina: 51661, Frisco: 235208, Garland: 250431, McKinney: 227526,
  Murphy: 21109, Plano: 293286, Princeton: 37019, Prosper: 44503,
  Richardson: 118221, Sachse: 33008, Wylie: 62954
};
...
async function main() {
  ...
  // Verify all 12 expected cities found
