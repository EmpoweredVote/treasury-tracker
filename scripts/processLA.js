#!/usr/bin/env node
/**
 * Louisiana General Fund Operating Budget Loader — FY2022-2026
 * Source: LA Division of Administration (doa.la.gov/opb)
 * LA fiscal year ends June 30. Education (MFP) + Health & Hospitals (Medicaid) dominate.
 * Significant natural resource and economic development spending.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processLA.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 10_000_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Hospitals', total: 3_200_000_000, lineItems: [
      { name: 'Medicaid/LaCHIP (state match)', amount: 2_800_000_000 },
      { name: 'Public Health (LDH)', amount: 250_000_000 },
      { name: 'Other Health Programs', amount: 150_000_000 },
    ]},
    { name: 'Education', total: 3_500_000_000, lineItems: [
      { name: 'K-12 Minimum Foundation Program (MFP)', amount: 2_700_000_000 },
      { name: 'Higher Education (LSU, Tulane, etc.)', amount: 600_000_000 },
    ...
    { name: 'Economic and Natural Resources', total: 1_100_000_000, lineItems: [
      { name: 'Natural Resources (LDNR)', amount: 500_000_000 },
      { name: 'Economic Development (LED)', amount: 300_000_000 },
    ...
    { name: 'Corrections and Public Safety', total: 700_000_000, lineItems: [
      ...
      { name: 'State Police', amount: 200_000_000 },
    ]},
  ]},
  2023: { total: 10_500_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Hospitals', total: 3_300_000_000, lineItems: [
      { name: 'Medicaid/LaCHIP (state match)', amount: 2_900_000_000 },
      { name: 'Public Health (LDH)', amount: 250_000_000 },
      { name: 'Other Health Programs', amount: 150_000_000 },
    ]},
    { name: 'Education', total: 3_700_000_000, lineItems: [
      { name: 'K-12 Minimum Foundation Program (MFP)', amount: 2_900_000_000 },
      { name: 'Higher Education (LSU, Tulane, etc.)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
  ...
  2024: { total: 10_000_000_000, confidence: 'estimated', categories: [
    ...
    { name: 'Education', total: 3_600_000_000, lineItems: [
      { name: 'K-12 Minimum Foundation Program (MFP)', amount: 2_800_000_000 },
      { name: 'Higher Education (LSU, Tulane, etc.)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    ...
    { name: 'Economic and Natural Resources', total: 1_000_000_000, lineItems: [
      { name: 'Natural Resources (LDNR)', amount: 500_000_000 },
      { name: 'Economic Development (LED)', amount: 250_000_000 },
      { name: 'Agriculture and Forestry', amount: 250_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 800_000_000, lineItems: [
      { name: 'Dept of Corrections', amount: 600_000_000 },
      { name: 'State Police', amount: 200_000_000 },
  ...
  2025: { total: 10_500_000_000, confidence: 'estimated', categories: [
    ...
    { name: 'Education', total: 3_800_000_000, lineItems: [
      { name: 'K-12 Minimum Foundation Program (MFP)', amount: 3_000_000_000 },
      { name: 'Higher Education (LSU, Tulane, etc.)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
  ...
  2026: { total: 10_500_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Hospitals', total: 3_400_000_000, lineItems: [
      { name: 'Medicaid/LaCHIP (state match)', amount: 3_000_000_000 },
      { name: 'Public Health (LDH)', amount: 250_000_000 },
      { name: 'Other Health Programs', amount: 150_000_000 },
    ]},
    { name: 'Education', total: 3_800_000_000, lineItems: [
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Louisiana General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'la-gf-operating', base_url: 'https://www.doa.la.gov/Pages/opb/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
