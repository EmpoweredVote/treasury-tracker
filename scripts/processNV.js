#!/usr/bin/env node
/**
 * Nevada General Fund Operating Budget Loader — FY2022-2026
 * Source: NV Department of Finance (budget.nv.gov)
 * NV fiscal year ends June 30 (biennial budget; amounts here are single-year estimates).
 * No income tax. Education + Health (Medicaid) are largest spending areas.
 * Revenue: sales tax (6.85%), gaming taxes, Modified Business Tax (payroll tax).
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processNV.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 8_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_200_000_000, lineItems: [
      { name: 'K-12 Education (Pupil-Centered Funding)', amount: 2_400_000_000 },
      { name: 'Higher Education (NSHE: UNLV, UNR system)', amount: 700_000_000 },
      { name: 'Other Education Programs', amount: 100_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_500_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 1_900_000_000 },
      { name: 'DCFS Child and Family Services', amount: 400_000_000 },
    ...
    { name: 'Corrections and Public Safety', total: 700_000_000, lineItems: [
      ...
      { name: 'Nevada Highway Patrol', amount: 200_000_000 },
    ]},
    { name: 'Economic Development', total: 400_000_000, lineItems: [
      { name: 'Economic Development and Tourism', amount: 250_000_000 },
      { name: 'Natural Resources', amount: 150_000_000 },
    ]},
  ]},
  2023: { total: 9_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_600_000_000, lineItems: [
      { name: 'K-12 Education (Pupil-Centered Funding)', amount: 2_800_000_000 },
      { name: 'Higher Education (NSHE: UNLV, UNR system)', amount: 700_000_000 },
      { name: 'Other Education Programs', amount: 100_000_000 },
    ]},
  ...
  2024: { total: 10_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_000_000_000, lineItems: [
      { name: 'K-12 Education (Pupil-Centered Funding)', amount: 3_100_000_000 },
      { name: 'Higher Education (NSHE: UNLV, UNR system)', amount: 800_000_000 },
      { name: 'Other Education Programs', amount: 100_000_000 },
    ]},
  ...
  2025: { total: 10_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_200_000_000, lineItems: [
      { name: 'K-12 Education (Pupil-Centered Funding)', amount: 3_300_000_000 },
      { name: 'Higher Education (NSHE: UNLV, UNR system)', amount: 800_000_000 },
      { name: 'Other Education Programs', amount: 100_000_000 },
    ]},
    { name: 'Health and Human Services', total: 3_200_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 2_600_000_000 },
      { name: 'DCFS Child and Family Services', amount: 400_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
    { name: 'General Government', total: 1_700_000_000, lineItems: [
  ...
  2026: { total: 11_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_400_000_000, lineItems: [
      { name: 'K-12 Education (Pupil-Centered Funding)', amount: 3_500_000_000 },
      { name: 'Higher Education (NSHE: UNLV, UNR system)', amount: 800_000_000 },
      { name: 'Other Education Programs', amount: 100_000_000 },
    ]},
    { name: 'Health and Human Services', total: 3_400_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 2_800_000_000 },
      { name: 'DCFS Child and Family Services', amount: 400_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Nevada General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'nv-gf-operating', base_url: 'https://budget.nv.gov/Budgeting/Exec_Budget/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
