#!/usr/bin/env node
/**
 * Hawaii General Fund Operating Budget Loader — FY2022-2026
 * Source: HI Dept of Budget and Finance (budget.hawaii.gov)
 * HI fiscal year ends June 30. Very high per-capita spending. Medicaid + Education dominate.
 * Island state: high cost of living drives elevated government costs.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processHI.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 8_500_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Medicaid', total: 3_500_000_000, lineItems: [
      { name: 'Medicaid (MedQUEST, state match)', amount: 3_000_000_000 },
      { name: 'Public Health (DOH)', amount: 500_000_000 },
    ]},
    { name: 'Education', total: 2_500_000_000, lineItems: [
      { name: 'K-12 Department of Education (DOE)', amount: 2_200_000_000 },
      { name: 'University of Hawaii System', amount: 300_000_000 },
    ]},
    { name: 'Human Services', total: 1_000_000_000, lineItems: [
      { name: 'Human Services Programs (DHS)', amount: 700_000_000 },
    ...
    { name: 'Public Safety', total: 700_000_000, lineItems: [
      { name: 'Public Safety (Corrections, PSD)', amount: 400_000_000 },
      { name: 'Attorney General and Courts', amount: 300_000_000 },
    ]},
  ]},
  2023: { total: 9_000_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Medicaid', total: 3_700_000_000, lineItems: [
      { name: 'Medicaid (MedQUEST, state match)', amount: 3_200_000_000 },
      { name: 'Public Health (DOH)', amount: 500_000_000 },
    ]},
    { name: 'Education', total: 2_700_000_000, lineItems: [
      { name: 'K-12 Department of Education (DOE)', amount: 2_400_000_000 },
      { name: 'University of Hawaii System', amount: 300_000_000 },
    ]},
    { name: 'Human Services', total: 1_100_000_000, lineItems: [
      { name: 'Human Services Programs (DHS)', amount: 800_000_000 },
      { name: 'Other Human Services', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 800_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 600_000_000 },
  ...
  2024: { total: 9_500_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Medicaid', total: 3_900_000_000, lineItems: [
      { name: 'Medicaid (MedQUEST, state match)', amount: 3_400_000_000 },
      { name: 'Public Health (DOH)', amount: 500_000_000 },
    ]},
    { name: 'Education', total: 2_800_000_000, lineItems: [
      { name: 'K-12 Department of Education (DOE)', amount: 2_500_000_000 },
      { name: 'University of Hawaii System', amount: 300_000_000 },
    ]},
    { name: 'Human Services', total: 1_200_000_000, lineItems: [
      { name: 'Human Services Programs (DHS)', amount: 900_000_000 },
      { name: 'Other Human Services', amount: 300_000_000 },
    ]},
  ...
  2025: { total: 10_000_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Medicaid', total: 4_100_000_000, lineItems: [
      { name: 'Medicaid (MedQUEST, state match)', amount: 3_600_000_000 },
      { name: 'Public Health (DOH)', amount: 500_000_000 },
    ]},
    { name: 'Education', total: 3_000_000_000, lineItems: [
      { name: 'K-12 Department of Education (DOE)', amount: 2_700_000_000 },
      { name: 'University of Hawaii System', amount: 300_000_000 },
    ]},
    { name: 'Human Services', total: 1_200_000_000, lineItems: [
      { name: 'Human Services Programs (DHS)', amount: 900_000_000 },
    ...
    { name: 'Public Safety', total: 800_000_000, lineItems: [
      { name: 'Public Safety (Corrections, PSD)', amount: 500_000_000 },
      { name: 'Attorney General and Courts', amount: 300_000_000 },
    ]},
  ]},
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Hawaii General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'hi-gf-operating', base_url: 'https://budget.hawaii.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
