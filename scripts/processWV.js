#!/usr/bin/env node
/**
 * West Virginia General Fund Operating Budget Loader — FY2022-2026
 * Source: WV Dept of Revenue (revenue.wv.gov) / WV Budget Office
 * WV fiscal year ends June 30. Medicaid dominates HHS spending.
 * Population declining; budget held up by severance tax windfall FY2022-2024.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processWV.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 4_500_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Resources', total: 1_800_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHR)', amount: 1_500_000_000 },
      { name: 'Other DHHR Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_500_000_000, lineItems: [
      { name: 'K-12 PEIA and State Aid', amount: 1_200_000_000 },
      { name: 'Higher Education (WVU, Marshall, etc.)', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 500_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 350_000_000 },
      { name: 'Courts and Judiciary', amount: 150_000_000 },
    ]},
    { name: 'Public Safety', total: 400_000_000, lineItems: [
      { name: 'Division of Corrections (DOC)', amount: 250_000_000 },
      { name: 'State Police', amount: 150_000_000 },
    ]},
    { name: 'Transportation and Other', total: 300_000_000, lineItems: [
      { name: 'Division of Highways (GF portion)', amount: 200_000_000 },
      { name: 'Other Programs', amount: 100_000_000 },
    ]},
  ]},
  2023: { total: 5_000_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Resources', total: 2_000_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHR)', amount: 1_700_000_000 },
      { name: 'Other DHHR Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_700_000_000, lineItems: [
      { name: 'K-12 PEIA and State Aid', amount: 1_400_000_000 },
      { name: 'Higher Education (WVU, Marshall, etc.)', amount: 300_000_000 },
    ]},
  ...
  2024: { total: 5_200_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Resources', total: 2_100_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHR)', amount: 1_800_000_000 },
      { name: 'Other DHHR Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_800_000_000, lineItems: [
      { name: 'K-12 PEIA and State Aid', amount: 1_500_000_000 },
      { name: 'Higher Education (WVU, Marshall, etc.)', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 600_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 400_000_000 },
  ...
  2025: { total: 5_000_000_000, confidence: 'estimated', categories: [
    ...
    { name: 'Transportation and Other', total: 200_000_000, lineItems: [
      { name: 'Division of Highways (GF portion)', amount: 150_000_000 },
      { name: 'Other Programs', amount: 50_000_000 },
    ]},
  ]},
  2026: { total: 4_800_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Resources', total: 1_900_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHR)', amount: 1_600_000_000 },
      { name: 'Other DHHR Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_700_000_000, lineItems: [
      { name: 'K-12 PEIA and State Aid', amount: 1_400_000_000 },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'West Virginia General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'wv-gf-operating', base_url: 'https://budget.wv.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
