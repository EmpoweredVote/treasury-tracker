#!/usr/bin/env node
/**
 * Wisconsin General Fund Operating (Expenditure) Loader — FY2002-FY2025 ACTUAL (24 yrs)
...
const dataSource = (fy) => `Wisconsin State ACFR — General Fund (FY${fy} actual, GAAP basis)`;
