#!/usr/bin/env node
/**
 * New Hampshire General Fund Operating Budget Loader — FY2022-2026
 * Source: NH Dept of Administrative Services (das.nh.gov)
 * NH fiscal year ends June 30. No income tax — small GF; K-12 funded by local property tax.
 * HHS/Medicaid dominates GF spending. Education adequacy grants from GF.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processNH.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 3_000_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Services', total: 1_200_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHS)', amount: 900_000_000 },
      { name: 'DCYF and Other HHS Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 900_000_000, lineItems: [
      { name: 'Adequacy Education Aid (grants to districts)', amount: 600_000_000 },
      { name: 'Community College System (CCSNH)', amount: 300_000_000 },
    ]},
    ...
    { name: 'Justice and Public Safety', total: 300_000_000, lineItems: [
      { name: 'Department of Corrections', amount: 200_000_000 },
      { name: 'State Police (NH DOJ and Trooper)', amount: 100_000_000 },
    ]},
    { name: 'Transportation and Other', total: 200_000_000, lineItems: [
      { name: 'NHDOT (GF portion)', amount: 100_000_000 },
      { name: 'Other Programs', amount: 100_000_000 },
    ]},
  ]},
  2023: { total: 3_200_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Services', total: 1_300_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHS)', amount: 1_000_000_000 },
      { name: 'DCYF and Other HHS Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_000_000_000, lineItems: [
      { name: 'Adequacy Education Aid (grants to districts)', amount: 700_000_000 },
      { name: 'Community College System (CCSNH)', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 400_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 300_000_000 },
  ...
  2024: { total: 3_500_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Services', total: 1_400_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHS)', amount: 1_100_000_000 },
      { name: 'DCYF and Other HHS Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_100_000_000, lineItems: [
      { name: 'Adequacy Education Aid (grants to districts)', amount: 800_000_000 },
      { name: 'Community College System (CCSNH)', amount: 300_000_000 },
    ]},
  ...
  2025: { total: 3_800_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Services', total: 1_500_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHS)', amount: 1_200_000_000 },
      { name: 'DCYF and Other HHS Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_200_000_000, lineItems: [
      { name: 'Adequacy Education Aid (grants to districts)', amount: 900_000_000 },
      { name: 'Community College System (CCSNH)', amount: 300_000_000 },
    ]},
  ...
  2026: { total: 4_000_000_000, confidence: 'estimated', categories: [
    { name: 'Health and Human Services', total: 1_600_000_000, lineItems: [
      { name: 'Medicaid (state match, DHHS)', amount: 1_300_000_000 },
      { name: 'DCYF and Other HHS Programs', amount: 300_000_000 },
    ]},
    { name: 'Education', total: 1_300_000_000, lineItems: [
      { name: 'Adequacy Education Aid (grants to districts)', amount: 1_000_000_000 },
      { name: 'Community College System (CCSNH)', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 600_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 500_000_000 },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'New Hampshire General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'nh-gf-operating', base_url: 'https://das.nh.gov/budget/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
