#!/usr/bin/env node
/**
 * Wyoming General Fund Revenue Loader — FY2022-2026
 * Source: Wyoming State Auditor's Office (sao.wyo.gov)
 * WY fiscal year ends June 30. NO income tax. Mineral Severance Tax + Federal Royalties dominant.
 * Coal, oil, and natural gas severance taxes + federal mineral royalty distributions.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processWYRevenue.js [--dry-run] [--fy YYYY]
 */
...
const REVENUE = {
  2022: { total: 2_000_000_000, confidence: 'estimated', categories: [
    { name: 'Mineral Severance Taxes and Federal Royalties', total: 800_000_000, lineItems: [
      { name: 'Coal Severance Tax', amount: 300_000_000 },
      { name: 'Oil and Gas Severance Tax', amount: 300_000_000 },
      { name: 'Federal Mineral Royalties (state share)', amount: 200_000_000 },
    ]},
    { name: 'Sales and Use Tax', total: 500_000_000, lineItems: [{ name: 'Sales and Use Tax (4%)', amount: 500_000_000 }] },
    { name: 'Other Revenue', total: 700_000_000, lineItems: [
      { name: 'Motor Vehicle and License Fees', amount: 100_000_000 },
      { name: 'Investment Income', amount: 200_000_000 },
      { name: 'Tobacco and Other Taxes', amount: 100_000_000 },
      { name: 'Other Fees and Transfers', amount: 300_000_000 },
    ]},
  ]},
  2023: { total: 2_400_000_000, confidence: 'estimated', categories: [
    { name: 'Mineral Severance Taxes and Federal Royalties', total: 1_000_000_000, lineItems: [
      { name: 'Coal Severance Tax', amount: 350_000_000 },
      { name: 'Oil and Gas Severance Tax', amount: 400_000_000 },
      { name: 'Federal Mineral Royalties (state share)', amount: 250_000_000 },
    ]},
    { name: 'Sales and Use Tax', total: 550_000_000, lineItems: [{ name: 'Sales and Use Tax (4%)', amount: 550_000_000 }] },
    { name: 'Other Revenue', total: 850_000_000, lineItems: [
      { name: 'Motor Vehicle and License Fees', amount: 100_000_000 },
      { name: 'Investment Income', amount: 280_000_000 },
      { name: 'Tobacco and Other Taxes', amount: 100_000_000 },
      { name: 'Other Fees and Transfers', amount: 370_000_000 },
    ]},
  ]},
  2024: { total: 2_100_000_000, confidence: 'estimated', categories: [
    ...
    { name: 'Sales and Use Tax', total: 550_000_000, lineItems: [{ name: 'Sales and Use Tax (4%)', amount: 550_000_000 }] },
    { name: 'Other Revenue', total: 750_000_000, lineItems: [
      { name: 'Motor Vehicle and License Fees', amount: 100_000_000 },
      { name: 'Investment Income', amount: 250_000_000 },
      { name: 'Tobacco and Other Taxes', amount: 100_000_000 },
      { name: 'Other Fees and Transfers', amount: 300_000_000 },
    ]},
  ]},
  2025: { total: 2_300_000_000, confidence: 'estimated', categories: [
    { name: 'Mineral Severance Taxes and Federal Royalties', total: 900_000_000, lineItems: [
      { name: 'Coal Severance Tax', amount: 320_000_000 },
      { name: 'Oil and Gas Severance Tax', amount: 360_000_000 },
      { name: 'Federal Mineral Royalties (state share)', amount: 220_000_000 },
    ]},
    { name: 'Sales and Use Tax', total: 600_000_000, lineItems: [{ name: 'Sales and Use Tax (4%)', amount: 600_000_000 }] },
    { name: 'Other Revenue', total: 800_000_000, lineItems: [
      { name: 'Motor Vehicle and License Fees', amount: 100_000_000 },
      { name: 'Investment Income', amount: 300_000_000 },
      { name: 'Tobacco and Other Taxes', amount: 100_000_000 },
      { name: 'Other Fees and Transfers', amount: 300_000_000 },
    ]},
  ]},
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Wyoming General Fund Revenue', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Revenue`, api_type: 'html', dataset_type: 'revenue', dataset_id: 'wy-gf-revenue', base_url: 'https://sao.wyo.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
