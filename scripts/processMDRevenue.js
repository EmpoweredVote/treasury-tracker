#!/usr/bin/env node
/**
 * Maryland General Fund Revenue Loader — FY2022-2026
 * Source: MD Dept of Budget and Management (dbm.maryland.gov)
 * MD fiscal year ends June 30. Strong income tax (top 5.75%) + Kirwan education funding.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processMDRevenue.js [--dry-run] [--fy YYYY]
 */
...
const REVENUE = {
  2022: { total: 13_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 8_000_000_000, lineItems: [{ name: 'Individual Income Tax (top 5.75%)', amount: 8_000_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_800_000_000, lineItems: [{ name: 'Sales and Use Tax (6%)', amount: 3_800_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_000_000_000, lineItems: [{ name: 'Corporate Income Tax (8.25%)', amount: 1_000_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Insurance Premiums Tax', amount: 300_000_000 },
      { name: 'Other Taxes and Fees', amount: 400_000_000 },
    ]},
  ]},
  2023: { total: 14_800_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 9_000_000_000, lineItems: [{ name: 'Individual Income Tax (top 5.75%)', amount: 9_000_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_000_000_000, lineItems: [{ name: 'Sales and Use Tax (6%)', amount: 4_000_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_100_000_000, lineItems: [{ name: 'Corporate Income Tax (8.25%)', amount: 1_100_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Insurance Premiums Tax', amount: 300_000_000 },
      { name: 'Other Taxes and Fees', amount: 400_000_000 },
    ]},
  ...
  2024: { total: 15_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 9_200_000_000, lineItems: [{ name: 'Individual Income Tax (top 5.75%)', amount: 9_200_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_000_000_000, lineItems: [{ name: 'Sales and Use Tax (6%)', amount: 4_000_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_100_000_000, lineItems: [{ name: 'Corporate Income Tax (8.25%)', amount: 1_100_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Insurance Premiums Tax', amount: 300_000_000 },
  ...
  2025: { total: 15_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 9_500_000_000, lineItems: [{ name: 'Individual Income Tax (top 5.75%)', amount: 9_500_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_200_000_000, lineItems: [{ name: 'Sales and Use Tax (6%)', amount: 4_200_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_100_000_000, lineItems: [{ name: 'Corporate Income Tax (8.25%)', amount: 1_100_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Insurance Premiums Tax', amount: 300_000_000 },
      { name: 'Other Taxes and Fees', amount: 400_000_000 },
  ...
  2026: { total: 15_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 9_100_000_000, lineItems: [{ name: 'Individual Income Tax (top 5.75%)', amount: 9_100_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_100_000_000, lineItems: [{ name: 'Sales and Use Tax (6%)', amount: 4_100_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_100_000_000, lineItems: [{ name: 'Corporate Income Tax (8.25%)', amount: 1_100_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Insurance Premiums Tax', amount: 300_000_000 },
      { name: 'Other Taxes and Fees', amount: 400_000_000 },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Maryland General Fund Revenue', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Revenue`, api_type: 'html', dataset_type: 'revenue', dataset_id: 'md-gf-revenue', base_url: 'https://dbm.maryland.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
