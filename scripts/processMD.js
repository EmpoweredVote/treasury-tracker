#!/usr/bin/env node
/**
 * Maryland General Fund Operating Budget Loader — FY2022-2026
 * Source: MD Dept of Budget and Management (dbm.maryland.gov)
 * MD fiscal year ends June 30. Education (Kirwan Blueprint) + Medicaid are largest categories.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processMD.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 13_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_500_000_000, lineItems: [
      { name: 'K-12 (Blueprint/Kirwan Formula)', amount: 3_200_000_000 },
    ...
    { name: 'Health and Human Services', total: 4_000_000_000, lineItems: [
      ...
      { name: 'Social Services (DHR)', amount: 500_000_000 },
      { name: 'Mental Health (BHSA)', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 2_500_000_000, lineItems: [
      { name: 'State Agencies', amount: 1_800_000_000 },
      { name: 'Judiciary and Courts', amount: 700_000_000 },
    ]},
    { name: 'Public Safety and Corrections', total: 1_500_000_000, lineItems: [
      { name: 'Dept of Public Safety and Corrections', amount: 1_000_000_000 },
      { name: 'State Police', amount: 500_000_000 },
    ]},
    { name: 'Debt Service', total: 1_000_000_000, lineItems: [
      { name: 'General Obligation Bond Debt Service', amount: 1_000_000_000 },
    ]},
  ]},
  2023: { total: 14_800_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 5_500_000_000, lineItems: [
      { name: 'K-12 (Blueprint/Kirwan Formula)', amount: 4_000_000_000 },
    ...
    { name: 'Health and Human Services', total: 4_200_000_000, lineItems: [
      ...
      { name: 'Social Services (DHR)', amount: 550_000_000 },
      { name: 'Mental Health (BHSA)', amount: 350_000_000 },
    ]},
    { name: 'General Government', total: 2_600_000_000, lineItems: [
      { name: 'State Agencies', amount: 1_900_000_000 },
      { name: 'Judiciary and Courts', amount: 700_000_000 },
    ]},
    { name: 'Public Safety and Corrections', total: 1_500_000_000, lineItems: [
      { name: 'Dept of Public Safety and Corrections', amount: 1_000_000_000 },
  ...
  2024: { total: 15_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 5_700_000_000, lineItems: [
      { name: 'K-12 (Blueprint/Kirwan Formula)', amount: 4_200_000_000 },
      { name: 'Higher Education', amount: 1_000_000_000 },
      { name: 'Other Education Programs', amount: 500_000_000 },
    ]},
  ...
  2025: { total: 15_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_000_000_000, lineItems: [
      { name: 'K-12 (Blueprint/Kirwan Formula)', amount: 4_500_000_000 },
      { name: 'Higher Education', amount: 1_000_000_000 },
      { name: 'Other Education Programs', amount: 500_000_000 },
    ]},
  ...
  2026: { total: 15_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 5_800_000_000, lineItems: [
      { name: 'K-12 (Blueprint/Kirwan Formula)', amount: 4_300_000_000 },
      { name: 'Higher Education', amount: 1_000_000_000 },
      { name: 'Other Education Programs', amount: 500_000_000 },
    ]},
    { name: 'Health and Human Services', total: 4_200_000_000, lineItems: [
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Maryland General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'md-gf-operating', base_url: 'https://dbm.maryland.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
