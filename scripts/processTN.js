#!/usr/bin/env node
/**
 * Tennessee General Fund Operating Budget Loader — FY2022-2026
 * Source: TN Dept of Finance and Administration (tn.gov/finance)
 * TN fiscal year ends June 30. Education (BEP formula) and TennCare/Medicaid largest.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processTN.js [--dry-run] [--fy YYYY]
 */
...
loadEnv();
const STATE_NAME = 'Tennessee'; const STATE_ABBR = 'TN'; const POPULATION = 7_126_489;
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://kxsdzaojfaibhuzmclfq.supabase.co';
const SUPABASE_KEY = process.env.SUPABASE_SERVICE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY;

const EXPENDITURES = {
  2022: { total: 14_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 5_800_000_000, lineItems: [
      { name: 'K-12 BEP Formula', amount: 4_500_000_000 },
    ...
    { name: 'Health and Human Services', total: 4_500_000_000, lineItems: [
      { name: 'TennCare/Medicaid (state match)', amount: 3_200_000_000 },
      { name: 'Social Services', amount: 800_000_000 },
    ...
    { name: 'Corrections and Public Safety', total: 1_000_000_000, lineItems: [
      { name: 'Dept of Correction', amount: 1_000_000_000 },
    ]},
    { name: 'Other Programs', total: 1_700_000_000, lineItems: [
      { name: 'Economic and Community Development', amount: 600_000_000 },
      { name: 'Natural Resources and Environment', amount: 400_000_000 },
      { name: 'Other State Programs', amount: 700_000_000 },
    ]},
  ]},
  2023: { total: 16_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_500_000_000, lineItems: [
      { name: 'K-12 BEP Formula', amount: 5_000_000_000 },
      { name: 'Higher Education', amount: 1_100_000_000 },
      { name: 'Other Education Programs', amount: 400_000_000 },
    ]},
    { name: 'Health and Human Services', total: 5_000_000_000, lineItems: [
      { name: 'TennCare/Medicaid (state match)', amount: 3_600_000_000 },
      { name: 'Social Services', amount: 900_000_000 },
      { name: 'Mental Health and Substance Use', amount: 500_000_000 },
    ]},
  ...
  2025: { total: 16_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_500_000_000, lineItems: [
      { name: 'K-12 BEP Formula', amount: 5_000_000_000 },
      { name: 'Higher Education', amount: 1_100_000_000 },
      { name: 'Other Education Programs', amount: 400_000_000 },
    ]},
    { name: 'Health and Human Services', total: 5_200_000_000, lineItems: [
      { name: 'TennCare/Medicaid (state match)', amount: 3_700_000_000 },
      { name: 'Social Services', amount: 1_000_000_000 },
      { name: 'Mental Health and Substance Use', amount: 500_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
      { name: 'State Operations', amount: 1_000_000_000 },
  ...
  2026: { total: 16_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_800_000_000, lineItems: [
      { name: 'K-12 BEP Formula', amount: 5_200_000_000 },
      { name: 'Higher Education', amount: 1_200_000_000 },
      { name: 'Other Education Programs', amount: 400_000_000 },
    ]},
    { name: 'Health and Human Services', total: 5_400_000_000, lineItems: [
      { name: 'TennCare/Medicaid (state match)', amount: 3_900_000_000 },
      { name: 'Social Services', amount: 1_000_000_000 },
      { name: 'Mental Health and Substance Use', amount: 500_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Tennessee General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'tn-gf-operating', base_url: 'https://www.tn.gov/finance/budget.html', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
