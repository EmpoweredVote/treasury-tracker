#!/usr/bin/env node
/**
 * Wisconsin General Fund Revenue (by source) Loader — FY2000-FY2025 ACTUAL (26 yrs)
...
const dataSource = (fy) => fy <= PRE34_LAST_FY
  ? `Wisconsin State CAFR — General Fund Revenue (FY${fy} actual, pre-GASB-34 combined statement basis)`
  : `Wisconsin State ACFR — General Fund Revenue (FY${fy} actual, GAAP basis)`;
