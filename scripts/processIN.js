#!/usr/bin/env node
/**
 * Indiana General Fund Operating Budget Loader — FY2022-2026
 * Source: IN State Budget Agency (in.gov/sba)
 * IN fiscal year ends June 30. Education and Medicaid are largest categories.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processIN.js [--dry-run] [--fy YYYY]
 */
...
loadEnv();
const STATE_NAME = 'Indiana'; const STATE_ABBR = 'IN'; const POPULATION = 6_833_037;
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://kxsdzaojfaibhuzmclfq.supabase.co';
const SUPABASE_KEY = process.env.SUPABASE_SERVICE_KEY || process.env.SUPABASE_SERVICE_ROLE_KEY;

const EXPENDITURES = {
  2022: { total: 17_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_000_000_000, lineItems: [
      { name: 'K-12 Tuition Support', amount: 4_000_000_000 },
      { name: 'Higher Education', amount: 1_500_000_000 },
      { name: 'Other Education', amount: 500_000_000 },
    ]},
    { name: 'Health and Human Services', total: 6_500_000_000, lineItems: [
      { name: 'Medicaid (FSSA state match)', amount: 4_500_000_000 },
      { name: 'Family and Social Services', amount: 1_500_000_000 },
      { name: 'Mental Health and Addiction', amount: 500_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
      { name: 'State Operations', amount: 1_000_000_000 },
      { name: 'Judiciary and Courts', amount: 500_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 1_200_000_000, lineItems: [
      { name: 'Dept of Correction', amount: 1_200_000_000 },
    ]},
    { name: 'Other Programs', total: 2_300_000_000, lineItems: [
      { name: 'Workforce Development', amount: 600_000_000 },
  ...
  2023: { total: 19_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_500_000_000, lineItems: [
      { name: 'K-12 Tuition Support', amount: 4_300_000_000 },
      { name: 'Higher Education', amount: 1_700_000_000 },
      { name: 'Other Education', amount: 500_000_000 },
    ]},
    { name: 'Health and Human Services', total: 7_000_000_000, lineItems: [
      { name: 'Medicaid (FSSA state match)', amount: 5_000_000_000 },
      { name: 'Family and Social Services', amount: 1_500_000_000 },
      { name: 'Mental Health and Addiction', amount: 500_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
    ...
    { name: 'Corrections and Public Safety', total: 1_300_000_000, lineItems: [
      { name: 'Dept of Correction', amount: 1_300_000_000 },
    ]},
    { name: 'Other Programs', total: 2_700_000_000, lineItems: [
      { name: 'Workforce Development', amount: 700_000_000 },
  ...
  2024: { total: 18_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_500_000_000, lineItems: [
      { name: 'K-12 Tuition Support', amount: 4_300_000_000 },
      { name: 'Higher Education', amount: 1_700_000_000 },
      { name: 'Other Education', amount: 500_000_000 },
    ...
    { name: 'Health and Human Services', total: 6_500_000_000, lineItems: [
      { name: 'Medicaid (FSSA state match)', amount: 4_600_000_000 },
      { name: 'Family and Social Services', amount: 1_400_000_000 },
      { name: 'Mental Health and Addiction', amount: 500_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
      { name: 'State Operations', amount: 1_000_000_000 },
  ...
  2025: { total: 19_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_700_000_000, lineItems: [
      { name: 'K-12 Tuition Support', amount: 4_400_000_000 },
    ...
    { name: 'Other Programs', total: 2_500_000_000, lineItems: [
      { name: 'Workforce Development', amount: 600_000_000 },
      { name: 'Natural Resources', amount: 600_000_000 },
      { name: 'Economic Development', amount: 700_000_000 },
      { name: 'Other State Programs', amount: 600_000_000 },
  ...
  2026: { total: 19_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 6_900_000_000, lineItems: [
      { name: 'K-12 Tuition Support', amount: 4_600_000_000 },
      { name: 'Higher Education', amount: 1_800_000_000 },
      { name: 'Other Education', amount: 500_000_000 },
    ]},
    { name: 'Health and Human Services', total: 7_200_000_000, lineItems: [
      { name: 'Medicaid (FSSA state match)', amount: 5_100_000_000 },
      { name: 'Family and Social Services', amount: 1_600_000_000 },
      { name: 'Mental Health and Addiction', amount: 500_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
      { name: 'State Operations', amount: 1_000_000_000 },
    ...
    { name: 'Other Programs', total: 2_600_000_000, lineItems: [
      { name: 'Workforce Development', amount: 700_000_000 },
      { name: 'Natural Resources', amount: 600_000_000 },
      { name: 'Economic Development', amount: 700_000_000 },
      { name: 'Other State Programs', amount: 600_000_000 },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Indiana General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'in-gf-operating', base_url: 'https://www.in.gov/sba/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
