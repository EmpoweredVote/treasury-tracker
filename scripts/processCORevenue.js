#!/usr/bin/env node
/**
 * Colorado General Fund Revenue Loader — FY2022-2026
 * Source: CO Legislative Council (leg.colorado.gov/appropriations)
 * CO fiscal year ends June 30. Flat income tax 4.4% (lowered from 4.55% in 2022).
 * TABOR: revenue surpluses trigger taxpayer refunds; GF appropriations shown here.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processCORevenue.js [--dry-run] [--fy YYYY]
 */
...
const REVENUE = {
  2022: { total: 12_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 6_800_000_000, lineItems: [{ name: 'Individual Income Tax (4.4% flat)', amount: 6_800_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_200_000_000, lineItems: [{ name: 'Sales and Use Tax (2.9% state rate)', amount: 3_200_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_300_000_000, lineItems: [{ name: 'Corporate Income Tax (4.4%)', amount: 1_300_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Federal Mineral Leasing', amount: 400_000_000 },
      { name: 'Other Taxes and Fees', amount: 300_000_000 },
    ]},
  ]},
  2023: { total: 13_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 7_500_000_000, lineItems: [{ name: 'Individual Income Tax (4.4% flat)', amount: 7_500_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_800_000_000, lineItems: [{ name: 'Sales and Use Tax (2.9% state rate)', amount: 3_800_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_500_000_000, lineItems: [{ name: 'Corporate Income Tax (4.4%)', amount: 1_500_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Federal Mineral Leasing', amount: 400_000_000 },
      { name: 'Other Taxes and Fees', amount: 300_000_000 },
    ]},
  ...
  2024: { total: 14_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 8_100_000_000, lineItems: [{ name: 'Individual Income Tax (4.4% flat)', amount: 8_100_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_000_000_000, lineItems: [{ name: 'Sales and Use Tax (2.9% state rate)', amount: 4_000_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_700_000_000, lineItems: [{ name: 'Corporate Income Tax (4.4%)', amount: 1_700_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Federal Mineral Leasing', amount: 400_000_000 },
      { name: 'Other Taxes and Fees', amount: 300_000_000 },
    ]},
  ...
  2025: { total: 15_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 8_400_000_000, lineItems: [{ name: 'Individual Income Tax (4.4% flat)', amount: 8_400_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_200_000_000, lineItems: [{ name: 'Sales and Use Tax (2.9% state rate)', amount: 4_200_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_700_000_000, lineItems: [{ name: 'Corporate Income Tax (4.4%)', amount: 1_700_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 700_000_000, lineItems: [
      { name: 'Federal Mineral Leasing', amount: 400_000_000 },
      { name: 'Other Taxes and Fees', amount: 300_000_000 },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Colorado General Fund Revenue', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Revenue`, api_type: 'html', dataset_type: 'revenue', dataset_id: 'co-gf-revenue', base_url: 'https://leg.colorado.gov/appropriations', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
