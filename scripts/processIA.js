#!/usr/bin/env node
/**
 * Iowa General Fund Operating Budget Loader — FY2022-2026
 * Source: IA Department of Management (dom.iowa.gov)
 * IA fiscal year ends June 30. Education + Health (Medicaid) dominate.
 * Income tax cut from graduated (8.53% max) progressively to 3.8% flat by FY2026.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processIA.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 8_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_200_000_000, lineItems: [
      { name: 'K-12 State Foundation Formula', amount: 2_400_000_000 },
      { name: 'Board of Regents (U of Iowa, ISU, UNI)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_600_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 2_000_000_000 },
      { name: 'DHS Family Services', amount: 400_000_000 },
    ...
    { name: 'Corrections and Public Safety', total: 800_000_000, lineItems: [
      ...
      { name: 'Iowa State Patrol', amount: 200_000_000 },
    ]},
    { name: 'Agriculture and Natural Resources', total: 500_000_000, lineItems: [
      { name: 'Iowa Dept of Agriculture', amount: 300_000_000 },
      { name: 'Natural Resources and Economic Development', amount: 200_000_000 },
    ]},
  ]},
  2023: { total: 9_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_400_000_000, lineItems: [
      { name: 'K-12 State Foundation Formula', amount: 2_600_000_000 },
      { name: 'Board of Regents (U of Iowa, ISU, UNI)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
  ...
  2024: { total: 9_200_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_500_000_000, lineItems: [
      { name: 'K-12 State Foundation Formula', amount: 2_700_000_000 },
      { name: 'Board of Regents (U of Iowa, ISU, UNI)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_800_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 2_200_000_000 },
      { name: 'DHS Family Services', amount: 400_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
  ...
  2025: { total: 9_400_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_600_000_000, lineItems: [
      { name: 'K-12 State Foundation Formula', amount: 2_800_000_000 },
      { name: 'Board of Regents (U of Iowa, ISU, UNI)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_900_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 2_300_000_000 },
      { name: 'DHS Family Services', amount: 400_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
    { name: 'General Government', total: 1_500_000_000, lineItems: [
  ...
  2026: { total: 9_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_700_000_000, lineItems: [
      { name: 'K-12 State Foundation Formula', amount: 2_900_000_000 },
      { name: 'Board of Regents (U of Iowa, ISU, UNI)', amount: 600_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_900_000_000, lineItems: [
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Iowa General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'ia-gf-operating', base_url: 'https://dom.iowa.gov/budget', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
