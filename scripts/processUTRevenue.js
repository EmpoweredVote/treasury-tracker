#!/usr/bin/env node
/**
 * Utah General Fund + Education Fund Revenue Loader — FY2022-2026
 * Source: UT State Tax Commission / Division of Finance (finance.utah.gov)
 * UT fiscal year ends June 30. Income tax 4.65% flat; constitutionally dedicated to education.
 * Sales tax 4.85% state rate (locals add 1-3%). Strong growth in all revenues due to population boom.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processUTRevenue.js [--dry-run] [--fy YYYY]
 */
...
const REVENUE = {
  2022: { total: 10_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 5_200_000_000, lineItems: [{ name: 'Individual Income Tax (4.85% flat, Education Fund)', amount: 5_200_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_400_000_000, lineItems: [{ name: 'Sales and Use Tax (4.85% state rate)', amount: 3_400_000_000 }] },
    ...
    { name: 'Other Revenue', total: 600_000_000, lineItems: [
      { name: 'Motor Fuel Tax', amount: 300_000_000 },
      { name: 'Miscellaneous Revenue', amount: 300_000_000 },
    ]},
  ]},
  2023: { total: 11_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 6_000_000_000, lineItems: [{ name: 'Individual Income Tax (4.85% flat, Education Fund)', amount: 6_000_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_900_000_000, lineItems: [{ name: 'Sales and Use Tax (4.85% state rate)', amount: 3_900_000_000 }] },
  ...
  2024: { total: 12_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 6_500_000_000, lineItems: [{ name: 'Individual Income Tax (4.65% flat, Education Fund)', amount: 6_500_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_200_000_000, lineItems: [{ name: 'Sales and Use Tax (4.85% state rate)', amount: 4_200_000_000 }] },
    ...
    { name: 'Other Revenue', total: 700_000_000, lineItems: [
      { name: 'Motor Fuel Tax', amount: 350_000_000 },
      { name: 'Miscellaneous Revenue', amount: 350_000_000 },
    ]},
  ]},
  2025: { total: 13_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 7_000_000_000, lineItems: [{ name: 'Individual Income Tax (4.65% flat, Education Fund)', amount: 7_000_000_000 }] },
    { name: 'Sales and Use Tax', total: 4_700_000_000, lineItems: [{ name: 'Sales and Use Tax (4.85% state rate)', amount: 4_700_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_100_000_000, lineItems: [{ name: 'Corporate Income Tax', amount: 1_100_000_000 }] },
    { name: 'Other Revenue', total: 700_000_000, lineItems: [
      { name: 'Motor Fuel Tax', amount: 350_000_000 },
      { name: 'Miscellaneous Revenue', amount: 350_000_000 },
  ...
  2026: { total: 14_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 7_500_000_000, lineItems: [{ name: 'Individual Income Tax (4.65% flat, Education Fund)', amount: 7_500_000_000 }] },
    { name: 'Sales and Use Tax', total: 5_200_000_000, lineItems: [{ name: 'Sales and Use Tax (4.85% state rate)', amount: 5_200_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_100_000_000, lineItems: [{ name: 'Corporate Income Tax', amount: 1_100_000_000 }] },
    { name: 'Other Revenue', total: 700_000_000, lineItems: [
      { name: 'Motor Fuel Tax', amount: 350_000_000 },
      { name: 'Miscellaneous Revenue', amount: 350_000_000 },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Utah General Fund Revenue', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Revenue`, api_type: 'html', dataset_type: 'revenue', dataset_id: 'ut-gf-revenue', base_url: 'https://tax.utah.gov/commission/reports', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
