#!/usr/bin/env node
/**
 * Indiana General Fund Revenue Loader — FY2022-2026
 * Source: IN State Budget Agency (in.gov/sba)
 * IN fiscal year ends June 30. Flat income tax (3.05%) + high sales tax (7%).
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processINRevenue.js [--dry-run] [--fy YYYY]
 */
...
const REVENUE = {
  2022: { total: 17_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 8_500_000_000, lineItems: [{ name: 'Individual Income Tax (flat 3.05%)', amount: 8_500_000_000 }] },
    { name: 'Sales and Use Tax', total: 7_000_000_000, lineItems: [{ name: 'Sales and Use Tax (7%)', amount: 7_000_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_000_000_000, lineItems: [{ name: 'Corporate Adjusted Gross Income Tax', amount: 1_000_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 1_000_000_000, lineItems: [
      { name: 'Financial Institutions Tax', amount: 300_000_000 },
      { name: 'Gaming and Other Taxes', amount: 400_000_000 },
      { name: 'Other Fees and Revenues', amount: 300_000_000 },
    ]},
  ]},
  2023: { total: 19_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 9_500_000_000, lineItems: [{ name: 'Individual Income Tax (flat 3.05%)', amount: 9_500_000_000 }] },
    { name: 'Sales and Use Tax', total: 7_500_000_000, lineItems: [{ name: 'Sales and Use Tax (7%)', amount: 7_500_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_000_000_000, lineItems: [{ name: 'Corporate Adjusted Gross Income Tax', amount: 1_000_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 1_000_000_000, lineItems: [
      { name: 'Financial Institutions Tax', amount: 300_000_000 },
      { name: 'Gaming and Other Taxes', amount: 400_000_000 },
  ...
  2024: { total: 18_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 9_000_000_000, lineItems: [{ name: 'Individual Income Tax (flat 3.05%)', amount: 9_000_000_000 }] },
    { name: 'Sales and Use Tax', total: 7_500_000_000, lineItems: [{ name: 'Sales and Use Tax (7%)', amount: 7_500_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_000_000_000, lineItems: [{ name: 'Corporate Adjusted Gross Income Tax', amount: 1_000_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 1_000_000_000, lineItems: [
      { name: 'Financial Institutions Tax', amount: 300_000_000 },
  ...
  2026: { total: 19_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 9_800_000_000, lineItems: [{ name: 'Individual Income Tax (flat 3.05%)', amount: 9_800_000_000 }] },
    { name: 'Sales and Use Tax', total: 7_700_000_000, lineItems: [{ name: 'Sales and Use Tax (7%)', amount: 7_700_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_000_000_000, lineItems: [{ name: 'Corporate Adjusted Gross Income Tax', amount: 1_000_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 1_000_000_000, lineItems: [
      { name: 'Financial Institutions Tax', amount: 300_000_000 },
      { name: 'Gaming and Other Taxes', amount: 400_000_000 },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Indiana General Fund Revenue', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Revenue`, api_type: 'html', dataset_type: 'revenue', dataset_id: 'in-gf-revenue', base_url: 'https://www.in.gov/sba/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
