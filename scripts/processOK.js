#!/usr/bin/env node
/**
 * Oklahoma General Fund Operating Budget Loader — FY2022-2026
 * Source: OK Office of Management and Enterprise Services (omes.ok.gov)
 * OK fiscal year ends June 30. Education + Health + Human Services dominate.
 * Significant oil/gas production tax revenue. Income tax graduated (top 4.75%).
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processOK.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 9_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_200_000_000, lineItems: [
      { name: 'K-12 Common Education', amount: 2_400_000_000 },
      { name: 'Higher Education (OU, OSU system)', amount: 600_000_000 },
      { name: 'Career/Technology Education', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_700_000_000, lineItems: [
      { name: 'Medicaid (SoonerCare, state match)', amount: 2_000_000_000 },
      { name: 'DHS Family Services', amount: 500_000_000 },
    ...
    { name: 'General Government', total: 1_400_000_000, lineItems: [
      ...
      { name: 'Courts and Legislature', amount: 400_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 900_000_000, lineItems: [
      { name: 'Dept of Corrections', amount: 700_000_000 },
      { name: 'Oklahoma Highway Patrol', amount: 200_000_000 },
    ]},
    { name: 'Transportation and Natural Resources', total: 800_000_000, lineItems: [
      { name: 'Transportation Dept', amount: 500_000_000 },
      { name: 'Agriculture and Forestry', amount: 300_000_000 },
    ]},
  ]},
  2023: { total: 9_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_400_000_000, lineItems: [
      { name: 'K-12 Common Education', amount: 2_600_000_000 },
      { name: 'Higher Education (OU, OSU system)', amount: 600_000_000 },
      { name: 'Career/Technology Education', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_800_000_000, lineItems: [
      { name: 'Medicaid (SoonerCare, state match)', amount: 2_100_000_000 },
      { name: 'DHS Family Services', amount: 500_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
  ...
  2024: { total: 10_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_600_000_000, lineItems: [
      { name: 'K-12 Common Education', amount: 2_800_000_000 },
      { name: 'Higher Education (OU, OSU system)', amount: 600_000_000 },
      { name: 'Career/Technology Education', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 3_000_000_000, lineItems: [
      { name: 'Medicaid (SoonerCare, state match)', amount: 2_300_000_000 },
      { name: 'DHS Family Services', amount: 500_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
  ...
  2025: { total: 10_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_800_000_000, lineItems: [
      { name: 'K-12 Common Education', amount: 3_000_000_000 },
      { name: 'Higher Education (OU, OSU system)', amount: 600_000_000 },
      { name: 'Career/Technology Education', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 3_100_000_000, lineItems: [
      { name: 'Medicaid (SoonerCare, state match)', amount: 2_400_000_000 },
      { name: 'DHS Family Services', amount: 500_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
    ...
    { name: 'Corrections and Public Safety', total: 1_100_000_000, lineItems: [
  ...
  2026: { total: 11_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_000_000_000, lineItems: [
      { name: 'K-12 Common Education', amount: 3_200_000_000 },
      { name: 'Higher Education (OU, OSU system)', amount: 600_000_000 },
      { name: 'Career/Technology Education', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 3_200_000_000, lineItems: [
      { name: 'Medicaid (SoonerCare, state match)', amount: 2_500_000_000 },
      { name: 'DHS Family Services', amount: 500_000_000 },
      { name: 'Public Health', amount: 200_000_000 },
    ]},
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Oklahoma General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'ok-gf-operating', base_url: 'https://oklahoma.gov/omes/services/financial-reporting/state-financial-reporting.html', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
