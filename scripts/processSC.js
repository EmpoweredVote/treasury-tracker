#!/usr/bin/env node
/**
 * South Carolina General Fund Operating Budget Loader — FY2022-2026
 * Source: SC Executive Budget Office (budget.sc.gov)
 * SC fiscal year ends June 30. Education (EFA) + Medicaid are largest categories.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processSC.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 8_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 3_500_000_000, lineItems: [
      { name: 'K-12 Education (EFA formula)', amount: 2_600_000_000 },
      { name: 'Higher Education (USC, Clemson, etc.)', amount: 700_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_000_000_000, lineItems: [
      { name: 'Medicaid (SCDHHS state match)', amount: 1_600_000_000 },
      { name: 'DSS (children/families)', amount: 300_000_000 },
      { name: 'Mental Health', amount: 100_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 800_000_000, lineItems: [
      { name: 'Dept of Corrections', amount: 600_000_000 },
      { name: 'State Law Enforcement (SLED)', amount: 200_000_000 },
    ]},
    ...
    { name: 'Debt Service and Other', total: 700_000_000, lineItems: [
      { name: 'State Bond Debt Service', amount: 500_000_000 },
      { name: 'Other Appropriations', amount: 200_000_000 },
    ]},
  ]},
  2023: { total: 9_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_200_000_000, lineItems: [
      { name: 'K-12 Education (EFA formula)', amount: 3_200_000_000 },
      { name: 'Higher Education (USC, Clemson, etc.)', amount: 800_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_300_000_000, lineItems: [
      { name: 'Medicaid (SCDHHS state match)', amount: 1_800_000_000 },
      { name: 'DSS (children/families)', amount: 350_000_000 },
      { name: 'Mental Health', amount: 150_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 1_000_000_000, lineItems: [
      { name: 'Dept of Corrections', amount: 750_000_000 },
      { name: 'State Law Enforcement (SLED)', amount: 250_000_000 },
    ]},
    { name: 'General Government', total: 1_200_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 900_000_000 },
      { name: 'Courts and Judiciary', amount: 300_000_000 },
    ]},
    { name: 'Debt Service and Other', total: 800_000_000, lineItems: [
      { name: 'State Bond Debt Service', amount: 600_000_000 },
      { name: 'Other Appropriations', amount: 200_000_000 },
    ]},
  ]},
  2024: { total: 9_800_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_400_000_000, lineItems: [
      { name: 'K-12 Education (EFA formula)', amount: 3_300_000_000 },
      { name: 'Higher Education (USC, Clemson, etc.)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_400_000_000, lineItems: [
      { name: 'Medicaid (SCDHHS state match)', amount: 1_900_000_000 },
      { name: 'DSS (children/families)', amount: 350_000_000 },
      { name: 'Mental Health', amount: 150_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 1_000_000_000, lineItems: [
  ...
  2025: { total: 10_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_500_000_000, lineItems: [
      { name: 'K-12 Education (EFA formula)', amount: 3_400_000_000 },
      { name: 'Higher Education (USC, Clemson, etc.)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_500_000_000, lineItems: [
      { name: 'Medicaid (SCDHHS state match)', amount: 2_000_000_000 },
      { name: 'DSS (children/families)', amount: 350_000_000 },
      { name: 'Mental Health', amount: 150_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 1_000_000_000, lineItems: [
  ...
  2026: { total: 10_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_700_000_000, lineItems: [
      { name: 'K-12 Education (EFA formula)', amount: 3_600_000_000 },
      { name: 'Higher Education (USC, Clemson, etc.)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 200_000_000 },
    ]},
    { name: 'Health and Human Services', total: 2_600_000_000, lineItems: [
      { name: 'Medicaid (SCDHHS state match)', amount: 2_100_000_000 },
      { name: 'DSS (children/families)', amount: 350_000_000 },
      { name: 'Mental Health', amount: 150_000_000 },
    ]},
    { name: 'Corrections and Public Safety', total: 1_000_000_000, lineItems: [
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'South Carolina General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'sc-gf-operating', base_url: 'https://www.budget.sc.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
