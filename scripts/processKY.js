#!/usr/bin/env node
/**
 * Kentucky General Fund Operating Budget Loader — FY2022-2026
 * Source: KY Office of State Budget Director (osbd.ky.gov)
 * KY fiscal year ends June 30. Education (SEEK formula) + Medicaid dominate.
 * Income tax cut: 5% flat → 4.5% (FY2023) → 4% (FY2024).
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processKY.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 12_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_400_000_000, lineItems: [
      { name: 'K-12 SEEK Formula', amount: 3_200_000_000 },
      { name: 'Higher Education (UK, UofL system)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    { name: 'Health and Human Services', total: 3_800_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 3_000_000_000 },
      { name: 'DCBS Family Services', amount: 500_000_000 },
    ...
    { name: 'General Government', total: 2_100_000_000, lineItems: [
      ...
      { name: 'Legislature', amount: 200_000_000 },
    ]},
    { name: 'Corrections and Justice', total: 1_300_000_000, lineItems: [
      { name: 'Dept of Corrections', amount: 900_000_000 },
      { name: 'State Police', amount: 300_000_000 },
      { name: 'Juvenile Justice', amount: 100_000_000 },
    ]},
    { name: 'Transportation and Infrastructure', total: 900_000_000, lineItems: [
      { name: 'Transportation Cabinet Operations', amount: 600_000_000 },
  ...
  2023: { total: 13_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_600_000_000, lineItems: [
      { name: 'K-12 SEEK Formula', amount: 3_400_000_000 },
      { name: 'Higher Education (UK, UofL system)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    { name: 'Health and Human Services', total: 3_900_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 3_100_000_000 },
      { name: 'DCBS Family Services', amount: 500_000_000 },
      { name: 'Public Health', amount: 300_000_000 },
    ]},
    ...
    { name: 'Corrections and Justice', total: 1_400_000_000, lineItems: [
  ...
  2024: { total: 13_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 4_800_000_000, lineItems: [
      { name: 'K-12 SEEK Formula', amount: 3_600_000_000 },
      { name: 'Higher Education (UK, UofL system)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    ...
    { name: 'General Government', total: 2_300_000_000, lineItems: [
    ...
    { name: 'Transportation and Infrastructure', total: 1_000_000_000, lineItems: [
      { name: 'Transportation Cabinet Operations', amount: 700_000_000 },
      { name: 'Economic Development', amount: 300_000_000 },
    ]},
  ]},
  2025: { total: 14_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 5_000_000_000, lineItems: [
      { name: 'K-12 SEEK Formula', amount: 3_800_000_000 },
      { name: 'Higher Education (UK, UofL system)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    { name: 'Health and Human Services', total: 4_100_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 3_300_000_000 },
      { name: 'DCBS Family Services', amount: 500_000_000 },
      { name: 'Public Health', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 2_500_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 1_900_000_000 },
      { name: 'Courts and Judiciary', amount: 400_000_000 },
      { name: 'Legislature', amount: 200_000_000 },
    ]},
    { name: 'Corrections and Justice', total: 1_400_000_000, lineItems: [
  ...
  2026: { total: 14_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education', total: 5_200_000_000, lineItems: [
      { name: 'K-12 SEEK Formula', amount: 4_000_000_000 },
      { name: 'Higher Education (UK, UofL system)', amount: 900_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    { name: 'Health and Human Services', total: 4_200_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 3_400_000_000 },
      { name: 'DCBS Family Services', amount: 500_000_000 },
      { name: 'Public Health', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 2_600_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 2_000_000_000 },
      { name: 'Courts and Judiciary', amount: 400_000_000 },
      { name: 'Legislature', amount: 200_000_000 },
    ]},
    { name: 'Corrections and Justice', total: 1_500_000_000, lineItems: [
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Kentucky General Fund Budget', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'ky-gf-operating', base_url: 'https://osbd.ky.gov/Pages/Budget.aspx', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
