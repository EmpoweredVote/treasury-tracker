#!/usr/bin/env node
/**
 * Massachusetts General Fund Revenue Loader — FY2022-2026
 * Source: MA Executive Office for Administration and Finance (budget.digital.mass.gov)
 * MA fiscal year ends June 30.
 * Millionaires Tax surtax (4% on income >$1M) starts FY2024, adding ~$1.5-2B/yr.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processMARevenue.js [--dry-run] [--fy YYYY]
 */
...
const REVENUE = {
  2022: { total: 33_000_000_000, confidence: 'estimated', categories: [
    { name: 'Income Tax', total: 19_000_000_000, lineItems: [
      { name: 'Withholding and Estimated Payments', amount: 16_500_000_000 },
      { name: 'Capital Gains and Other', amount: 2_500_000_000 },
    ]},
    { name: 'Sales and Use Tax', total: 8_500_000_000, lineItems: [{ name: 'Sales and Use Tax', amount: 8_500_000_000 }] },
    { name: 'Corporate Excise Tax', total: 3_500_000_000, lineItems: [{ name: 'Corporate Excise Tax', amount: 3_500_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 2_000_000_000, lineItems: [
      { name: 'Estate Tax', amount: 600_000_000 },
      { name: 'Tobacco and Alcohol Excise', amount: 500_000_000 },
      { name: 'Other Taxes and Fees', amount: 900_000_000 },
    ]},
  ]},
  2023: { total: 36_000_000_000, confidence: 'estimated', categories: [
    { name: 'Income Tax', total: 21_500_000_000, lineItems: [
      { name: 'Withholding and Estimated Payments', amount: 18_000_000_000 },
      { name: 'Capital Gains and Other', amount: 3_500_000_000 },
    ]},
    { name: 'Sales and Use Tax', total: 9_000_000_000, lineItems: [{ name: 'Sales and Use Tax', amount: 9_000_000_000 }] },
    { name: 'Corporate Excise Tax', total: 3_500_000_000, lineItems: [{ name: 'Corporate Excise Tax', amount: 3_500_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 2_000_000_000, lineItems: [
      { name: 'Estate Tax', amount: 600_000_000 },
      { name: 'Tobacco and Alcohol Excise', amount: 500_000_000 },
  ...
  // FY2024+: Millionaires Tax surtax adds ~$1.5-2B/year on top of base income tax
  2024: { total: 34_500_000_000, confidence: 'estimated', categories: [
    { name: 'Income Tax', total: 19_500_000_000, lineItems: [
      { name: 'Withholding and Estimated Payments', amount: 16_000_000_000 },
      { name: 'Capital Gains and Other', amount: 2_000_000_000 },
      { name: 'Millionaires Tax Surtax (4% on >$1M)', amount: 1_500_000_000 },
    ]},
    { name: 'Sales and Use Tax', total: 9_500_000_000, lineItems: [{ name: 'Sales and Use Tax', amount: 9_500_000_000 }] },
    { name: 'Corporate Excise Tax', total: 3_500_000_000, lineItems: [{ name: 'Corporate Excise Tax', amount: 3_500_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 2_000_000_000, lineItems: [
      { name: 'Estate Tax', amount: 600_000_000 },
      { name: 'Tobacco and Alcohol Excise', amount: 500_000_000 },
  ...
  2025: { total: 36_000_000_000, confidence: 'estimated', categories: [
    { name: 'Income Tax', total: 21_000_000_000, lineItems: [
      { name: 'Withholding and Estimated Payments', amount: 17_000_000_000 },
      { name: 'Capital Gains and Other', amount: 2_200_000_000 },
      { name: 'Millionaires Tax Surtax (4% on >$1M)', amount: 1_800_000_000 },
    ]},
    { name: 'Sales and Use Tax', total: 9_500_000_000, lineItems: [{ name: 'Sales and Use Tax', amount: 9_500_000_000 }] },
    { name: 'Corporate Excise Tax', total: 3_500_000_000, lineItems: [{ name: 'Corporate Excise Tax', amount: 3_500_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 2_000_000_000, lineItems: [
  ...
  2026: { total: 37_500_000_000, confidence: 'estimated', categories: [
    { name: 'Income Tax', total: 22_000_000_000, lineItems: [
      { name: 'Withholding and Estimated Payments', amount: 18_000_000_000 },
      { name: 'Capital Gains and Other', amount: 2_000_000_000 },
      { name: 'Millionaires Tax Surtax (4% on >$1M)', amount: 2_000_000_000 },
    ]},
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Massachusetts General Fund Revenue', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Revenue`, api_type: 'html', dataset_type: 'revenue', dataset_id: 'ma-gf-revenue', base_url: 'https://budget.digital.mass.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
