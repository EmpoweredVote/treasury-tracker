#!/usr/bin/env node
/**
 * Missouri General Fund Revenue Loader — FY2022-2026
 * Source: MO Office of Administration Budget and Planning (oa.mo.gov)
 * MO fiscal year ends June 30. Income tax + sales tax (4.225% state rate).
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processMORevenue.js [--dry-run] [--fy YYYY]
 */
...
const REVENUE = {
  2022: { total: 10_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 5_500_000_000, lineItems: [{ name: 'Individual Income Tax', amount: 5_500_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_500_000_000, lineItems: [{ name: 'Sales and Use Tax (4.225%)', amount: 3_500_000_000 }] },
  ...
  2023: { total: 11_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 6_000_000_000, lineItems: [{ name: 'Individual Income Tax', amount: 6_000_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_800_000_000, lineItems: [{ name: 'Sales and Use Tax (4.225%)', amount: 3_800_000_000 }] },
  ...
  2024: { total: 11_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 5_700_000_000, lineItems: [{ name: 'Individual Income Tax', amount: 5_700_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_500_000_000, lineItems: [{ name: 'Sales and Use Tax (4.225%)', amount: 3_500_000_000 }] },
  ...
  2025: { total: 11_500_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 6_000_000_000, lineItems: [{ name: 'Individual Income Tax', amount: 6_000_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_700_000_000, lineItems: [{ name: 'Sales and Use Tax (4.225%)', amount: 3_700_000_000 }] },
    { name: 'Corporate Income Tax', total: 1_000_000_000, lineItems: [{ name: 'Corporate Income Tax', amount: 1_000_000_000 }] },
    { name: 'Other Taxes and Revenues', total: 800_000_000, lineItems: [
      { name: 'Insurance Premiums Tax', amount: 300_000_000 },
      { name: 'Other Taxes and Fees', amount: 500_000_000 },
  ...
  2026: { total: 12_000_000_000, confidence: 'estimated', categories: [
    { name: 'Individual Income Tax', total: 6_200_000_000, lineItems: [{ name: 'Individual Income Tax', amount: 6_200_000_000 }] },
    { name: 'Sales and Use Tax', total: 3_900_000_000, lineItems: [{ name: 'Sales and Use Tax (4.225%)', amount: 3_900_000_000 }] },
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Missouri General Fund Revenue', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Revenue`, api_type: 'html', dataset_type: 'revenue', dataset_id: 'mo-gf-revenue', base_url: 'https://oa.mo.gov/budget', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
