#!/usr/bin/env node
/**
 * Alabama General Fund Operating Budget Loader — FY2022-2026
 * Source: AL Department of Finance (budget.alabama.gov)
 * AL fiscal year ends September 30. Education Trust Fund (ETF) + State General Fund
 * treated as combined General Fund. Education (ETF) dominates spending.
 * Confidence: estimated for all years.
 *
 * Usage:
 *   node scripts/processAL.js [--dry-run] [--fy YYYY]
 */
...
const EXPENDITURES = {
  2022: { total: 9_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education (ETF)', total: 5_200_000_000, lineItems: [
      { name: 'K-12 Foundation Program (ETF)', amount: 3_900_000_000 },
      { name: 'Higher Education (UA, Auburn, etc.)', amount: 1_000_000_000 },
    ...
    { name: 'Medicaid', total: 1_200_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 1_200_000_000 },
    ]},
    { name: 'Corrections', total: 700_000_000, lineItems: [
      { name: 'Dept of Corrections', amount: 700_000_000 },
    ]},
    { name: 'Human Resources and Other', total: 400_000_000, lineItems: [
      { name: 'Dept of Human Resources (DHR)', amount: 250_000_000 },
      { name: 'Other State Programs', amount: 150_000_000 },
    ]},
  ]},
  2023: { total: 10_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education (ETF)', total: 6_000_000_000, lineItems: [
      { name: 'K-12 Foundation Program (ETF)', amount: 4_500_000_000 },
      { name: 'Higher Education (UA, Auburn, etc.)', amount: 1_200_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    ...
    { name: 'Medicaid', total: 1_400_000_000, lineItems: [
      { name: 'Medicaid (state match)', amount: 1_400_000_000 },
    ]},
    { name: 'Corrections', total: 800_000_000, lineItems: [
      { name: 'Dept of Corrections', amount: 800_000_000 },
    ]},
    { name: 'Human Resources and Other', total: 500_000_000, lineItems: [
      { name: 'Dept of Human Resources (DHR)', amount: 300_000_000 },
      { name: 'Other State Programs', amount: 200_000_000 },
    ]},
  ]},
  2024: { total: 10_800_000_000, confidence: 'estimated', categories: [
    { name: 'Education (ETF)', total: 6_200_000_000, lineItems: [
      { name: 'K-12 Foundation Program (ETF)', amount: 4_600_000_000 },
      { name: 'Higher Education (UA, Auburn, etc.)', amount: 1_300_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 1_800_000_000, lineItems: [
      { name: 'State Agency Operations', amount: 1_400_000_000 },
    ...
    { name: 'Medicaid', total: 1_500_000_000, lineItems: [
  ...
  2025: { total: 11_000_000_000, confidence: 'estimated', categories: [
    { name: 'Education (ETF)', total: 6_400_000_000, lineItems: [
      { name: 'K-12 Foundation Program (ETF)', amount: 4_800_000_000 },
      { name: 'Higher Education (UA, Auburn, etc.)', amount: 1_300_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    { name: 'General Government', total: 1_800_000_000, lineItems: [
  ...
  2026: { total: 11_500_000_000, confidence: 'estimated', categories: [
    { name: 'Education (ETF)', total: 6_700_000_000, lineItems: [
      { name: 'K-12 Foundation Program (ETF)', amount: 5_000_000_000 },
      { name: 'Higher Education (UA, Auburn, etc.)', amount: 1_400_000_000 },
      { name: 'Other Education Programs', amount: 300_000_000 },
    ]},
    ...
    { name: 'Medicaid', total: 1_600_000_000, lineItems: [
...
function buildTree(fy) {
  ...
  return { jsonTree: [{ n: 'Alabama General Fund Budget (ETF + GF Combined)', a: total, c: children }], total, rowCount: categories.length };
}
...
async function main() {
  ...
  let ds;
  if (!dryRun) {
    const srcPayload = { name: `${STATE_NAME} General Fund Operating Budget`, api_type: 'html', dataset_type: 'operating', dataset_id: 'al-gf-operating', base_url: 'https://budget.alabama.gov/', fiscal_years: [2022,2023,2024,2025,2026], municipality_id: muniId };
