...
**Data source (locked via recon — `.planning/research/UTAH-RECON.md`):** the Utah State Auditor's **Transparent Utah** public BigQuery dataset `ut-sao-transparency-prod.transaction.transaction`. One uniform table gives operating (`EX`), revenue (`RV`), and payroll (`PY`) for all 15 entities, **FY2014→present** (corrected 2026-06-19 via live probe — NOT FY2009 as first recon'd; FY2026 is current/near-complete). Free (BQ sandbox free tier, no card). Access GRANTED + verified live 2026-06-19. Actuals / all-governmental-funds basis — consistent with our existing CA county loads. opendata.utah.gov Socrata (FY≤2019) is a zero-auth cross-check only; per-entity ACFRs are the reconciliation/fallback source.
...
Plans:
- [x] TBD (run /gsd-plan-phase 71.1 to break down) (completed 2026-06-20)
...
<details>
<summary>✅ v2.3 California Coverage Parity (Phases 58-62) — SHIPPED 2026-06-17</summary>

Brought every already-loaded non-OC California city + county to the Orange County standard — FY2003 history depth, statewide salaries (2009–2024), standardized enrichment — by re-running the hardened v2.2 SoCal pipeline (no new tooling). Custom-source cities preserved via the never-overwrite guard; reconciled against published ACFRs with Chris UAT sign-off. SoCal expansion (SOCAL-01..06) deferred to v2.4. See [milestones/v2.3-ROADMAP.md](milestones/v2.3-ROADMAP.md).

- [x] Phase 58: LA County Parity Backfill (4/4 plans) — completed 2026-06-16
- [x] Phase 59: Remaining CA Cities History + Linking (4/4 plans) — completed 2026-06-16
- [x] Phase 60: Statewide CA Salaries Sweep (3/3 plans) — completed 2026-06-16
- [x] Phase 61: Enrichment Parity (1/1 plan) — completed 2026-06-16
- [x] Phase 62: ACFR Verification + Source-Chain Audit + UAT (3/3 plans) — completed 2026-06-17
