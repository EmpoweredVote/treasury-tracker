...
| _Oxnard FY2022 / Chula Vista FY2022 / Riverside city ≤FY2022_ | | _pending — downloads in progress_ | | | | | _pending doc_ |

**Running tally:** 4 of 7 reconciled (all PASS). **FUP-01 (Glendale + Burbank) is now CLOSED** — both reconciled, both PASS, the v2.3 access-blocked follow-up resolved. Combined with the prior-phase PASSes (LA County, Santa Monica, Pasadena, Ventura County), **8 distinct CA entities now reconciled** on the basis-matched method — every one within documented tolerance, zero data anomalies. Remaining: 3 SoCal-sample cities (Oxnard, Chula Vista, Riverside city — VER-05 follow-up) pending document downloads. With San Diego County + Riverside County + Ventura County now reconciled, **all 3 large SoCal county governments in the v2.4 sample are done.**
