...
- **NASBO category taxonomy (uniform, the 7 functions):** Elementary & Secondary Education (K-12), Higher Education, Public Assistance, Medicaid, Corrections, Transportation, All Other. Revenue taxonomy (Fiscal Survey): Sales Tax, Personal Income Tax, Corporate Income Tax, All Other (use the source's exact source-level breakdown where richer). Use the source's own category names verbatim.
