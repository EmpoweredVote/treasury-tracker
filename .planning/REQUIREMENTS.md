...
- [x] **ACFR-06**: User can see **Pennsylvania's** GF revenue-by-source and GAAP spending-by-function on the PA state node (ACFR-sourced, GAAP basis-labelled, NASBO operating replaced idempotently), as deep as the ACFR cleanly extracts.
- [x] **ACFR-07**: User can see **Illinois's** GF revenue-by-source and GAAP spending-by-function on the IL state node (ACFR-sourced, GAAP basis-labelled, NASBO operating replaced idempotently), as deep as the ACFR cleanly extracts.
