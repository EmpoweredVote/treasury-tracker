...
- [ ] **ACFR-43**: Nebraska (NE) upgraded NASBO→State-ACFR GAAP GF revenue-by-source + finer spending-by-function
- [ ] **ACFR-44**: Nevada (NV) upgraded NASBO→State-ACFR GAAP GF revenue-by-source + finer spending-by-function
...
- [ ] **ACFR-48**: Oklahoma (OK) upgraded NASBO→State-ACFR GAAP GF revenue-by-source + finer spending-by-function (recon preserved from v2.14)
- [ ] **ACFR-49**: Rhode Island (RI) upgraded NASBO→State-ACFR GAAP GF revenue-by-source + finer spending-by-function
- [ ] **ACFR-50**: South Dakota (SD) upgraded NASBO→State-ACFR GAAP GF revenue-by-source + finer spending-by-function
- [ ] **ACFR-51**: Vermont (VT) upgraded NASBO→State-ACFR GAAP GF revenue-by-source + finer spending-by-function
...
| ACFR-43 | Phase 120 | Pending |
| ACFR-44 | Phase 120 | Pending |
| ACFR-45 | Phase 120 | Pending |
| ACFR-46 | Phase 120 | Pending |
| ACFR-47 | Phase 120 | Pending |
| ACFR-48 | Phase 121 | Pending |
| ACFR-49 | Phase 121 | Pending |
| ACFR-50 | Phase 121 | Pending |
| ACFR-51 | Phase 121 | Pending |
