  ...
  return (
    <div className="space-y-4">
      ...
      {depth === 1 && hasSummaryInfo && (
        <div className="bg-white dark:bg-ev-gray-900 border border-[#E2EBEF] dark:border-ev-gray-700 rounded-xl overflow-hidden">
          <div className="px-6 py-4 bg-[#F7F7F8] dark:bg-ev-gray-800 border-b border-[#D3D7DE] dark:border-ev-gray-700">
            ...
            <div className="space-y-3">
              {summaryPoints.map((point, idx) => (
                <div key={idx} className="flex gap-3">
                  ...
                  <p className="text-sm text-[#1C1C1C] dark:text-ev-gray-200 leading-snug">{point}</p>
                </div>
              ))}
            </div>
            <a
      ...
      {hasSubcategories && (
        <div className="bg-white dark:bg-ev-gray-900 border border-[#E2EBEF] dark:border-ev-gray-700 rounded-xl overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 bg-[#F7F7F8] dark:bg-ev-gray-800 border-b border-[#D3D7DE] dark:border-ev-gray-700">
            <h3 className="text-base font-bold font-manrope text-[#1C1C1C] dark:text-ev-gray-100">
