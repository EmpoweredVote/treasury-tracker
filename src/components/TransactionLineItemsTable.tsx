    ...
    <div className="mt-6 bg-white dark:bg-ev-gray-900 border border-[#E2EBEF] dark:border-ev-gray-700 rounded-xl overflow-hidden">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-6 pb-4">
        <div className="bg-[#F7F7F8] dark:bg-ev-gray-800 rounded-lg p-4 border border-[#E2EBEF] dark:border-ev-gray-700">
          <div className="text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400 mb-2">Total Spending</div>
          <div className="text-2xl font-bold font-manrope text-ev-muted-blue tabular-nums">{formatCurrency(totalAmount)}</div>
        </div>
        <div className="bg-[#F7F7F8] dark:bg-ev-gray-800 rounded-lg p-4 border border-[#E2EBEF] dark:border-ev-gray-700">
          <div className="text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400 mb-2">Transactions</div>
          <div className="text-2xl font-bold font-manrope text-ev-muted-blue tabular-nums">{lineItems.length.toLocaleString()}</div>
        </div>
        <div className="bg-[#F7F7F8] dark:bg-ev-gray-800 rounded-lg p-4 border border-[#E2EBEF] dark:border-ev-gray-700">
          <div className="text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400 mb-2">Unique Vendors</div>
          <div className="text-2xl font-bold font-manrope text-ev-muted-blue tabular-nums">{uniqueVendors}</div>
        </div>
        <div className="bg-[#F7F7F8] dark:bg-ev-gray-800 rounded-lg p-4 border border-[#E2EBEF] dark:border-ev-gray-700">
          <div className="text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400 mb-2">Avg Transaction</div>
        ...
        <table className="w-full text-sm border-collapse">
          <thead className="bg-[#F7F7F8] dark:bg-ev-gray-800">
            <tr className="border-b border-[#D3D7DE] dark:border-ev-gray-700">
              <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400 w-[130px]">
                Date
              </th>
              <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400">
                Description
              </th>
              <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400 w-[200px]">
                Vendor
              </th>
              <th className="px-4 py-3 text-right text-xs font-bold uppercase tracking-wider text-[#6B7280] dark:text-ev-gray-400 w-[140px]">
                Amount
              </th>
            </tr>
          </thead>
          <tbody>
            {sortedItems.map((item, index) => (
              <tr key={index} className="border-b border-[#E2EBEF] dark:border-ev-gray-700 hover:bg-[#F7F7F8] dark:hover:bg-ev-gray-800 transition-colors duration-150">
                <td className="px-4 py-3 text-sm font-medium text-[#6B7280] dark:text-ev-gray-400 whitespace-nowrap align-top">
                ...
                <td className="px-4 py-3 align-top">
                  ...
                  {item.metadata?.expenseCategory && (
                    <div className="text-xs text-[#6B7280] dark:text-ev-gray-500 italic">
                      {item.metadata.expenseCategory}
                    </div>
                  )}
                </td>
                <td className="px-4 py-3 text-sm font-medium text-[#6B7280] dark:text-ev-gray-400 align-top">
